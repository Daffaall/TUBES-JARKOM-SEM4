...
# =====================================================================
PROXY_HOST = '10.85.141.180'       # IP mesin Proxy (bukan localhost lagi)
PROXY_PORT = 8080                # Port Proxy untuk TCP & UDP
SERVER_HOST = '10.85.141.163'   # IP mesin Server (bukan localhost lagi)
SERVER_PORT = 9000                # Port Server untuk HTTP
# =====================================================================
...
def test_udp():
    ...
    print(f"[*] Memulai UDP Ping ke Web Server ({SERVER_HOST}:{SERVER_PORT})")
